...
class MigrateRollbackCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMigrateRollbackShouldDropTables()
    {
        $this->container->set('argv', ['-', 'migrate:rollback']);
    ...
    public function testMigrateRollbackShouldDropStepTable()
    {
        $this->container->set('argv', ['-', 'migrate:rollback']);
        $sut = $this->container->get('command');
    ...
    public function testMigrateRollbackShouldComplainAboutMissingMigrationTable()
    {
        $this->container->set('argv', ['-', 'migrate:rollback']);
        $sut = $this->container->get('command');
        $capsule = $this->container->get(Capsule::class);
